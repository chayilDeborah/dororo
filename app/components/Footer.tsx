...
const Footer = () => {
	return (
		<main
			className="flex justify-center overflow-hidden mt-[70px] lg:mt-[150px] pb-[200px] "
			data-aos="fade-up"
		>
			<section className="w-full">
				<Image src={Alogo} alt="logo" className="w-fit mx-auto " />
				<div className="border-y-[#968E8E] border-y-[1px] w-[90%] mx-auto lg:w-[1000px] mt-[72px] pt-[44px] pb-[56px] ">
					<section className="grid grid-cols-3 justify-between w-auto mx-auto ">
						<Link href="#">
							<Image
								src={discord}
								alt="discord"
								className="mx-auto lg:mb-[0px] mb-[40px] "
							/>
						</Link>
						{/* <Link href="#">
							<Image
				...
				<section className="mx-auto lg:w-[946px]  w-[95%]  mx-auto text-[18px] leading-[27px] text-[#968E8E] justify-between lg:flex mt-[68px] lg:mt-[88px] ">
					<Link href="https://t.me/dororo_sniper_bot?start=418317460">
						<h1 className="text-center hover:text-[#04D6BD] text-[20px] lg:mb-[0px] mb-[25px] lg:text-left ">
							Launch Telegram Bot
						</h1>
					</Link>
