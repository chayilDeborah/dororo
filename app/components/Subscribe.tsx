  ...
  return (
    <main className='flex justify-center overflow-hidden  '>
        ...
        <div className='absolute w-full lg:mx-[0px] mx-auto flex flex-col justify-center '>
            ...
            <p className='text-[16px] lg:text-[20px] leading-[25px] lg:leading-[30px] mt-[19px] mb-[55px] w-[90%] mx-auto  lg:w-[65%] ' data-aos="fade-up" data-duration="1600">Lorem ipsum dolor sit amet consectetur. Nisl vulputate faucibus mauris elementum quam lacus mauris vulputate risus. Integer lobortis amet quam elementum. Dictumst aliquet.</p>
        ...
        <section className='lg:hidden block bg-[#0D0729] rounded-[34px] lg:rounded-[68px] w-[357px] text-white mx-auto mt-[150px] '>
            ...
            <div className=' w-[350px] h-[400px] bg-[url("https://res.cloudinary.com/dmye53wps/image/upload/v1714746499/peabig_umyg7z.png")] bg-cover bg-center w-full '>
                ...
                <p className='text-[15px] lg:text-[20px] leading-[25px] text-center lg:leading-[30px] mt-[19px] mb-[55px] w-[94%] mx-auto  '>Lorem ipsum dolor sit amet consectetur. Nisl vulputate faucibus mauris elementum quam lacus mauris vulputate risus. Integer lobortis amet quam elementum. Dictumst aliquet.</p>
