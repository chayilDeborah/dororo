    ...
    <main className='flex overflow-hidden justify-center'>
        <section className='lg:flex justify-between w-[95%]  mx-auto text-[#FFFFFF] '>
            <div className='mt-[50px] lg:mt-[137px] lg:w-[595px] text-center lg:text-left  '>
                ...
                <p className='text-[17px] lg:text-[28px] leading-[34px] lg:leading-[42px] w-[85%] lg:w-full lg:mx-[0px] mx-auto  font-semibold mb-[50px] ' data-aos-offset="10" data-aos="fade-up">Dororo Bot is the first trading bot on the Bobchain network, enabling users to automate cryptocurrency trading with enhanced security and liquidity.</p>
